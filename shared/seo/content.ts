...
export const TOOL_CONTENT: Record<string, LocalizedToolContent> = {
  ...
  "pdf-to-word": {
    en: {
      ...
      valueProposition: "Make PDF text editable again, working entirely in your browser. This extracts text into an editable document — it does not preserve exact layout, tables, or images.",
      benefits: ["Text becomes editable", "Saves retyping the document", "Free to use"],
      howToSteps: ["Upload the PDF", "The tool extracts its real text", "Download the Word document"],
      ...
      faq: [
        { question: "Does this preserve the exact layout, tables, and images from the PDF?", answer: "No — this tool extracts text into an editable document. It does not preserve exact visual layout, tables, embedded images, or guaranteed font/bold/italic formatting." },
        { question: "Is this tool free?", answer: "Yes, this tool is free to use, like all Codivio tools." },
        { question: "Does this work on scanned PDFs?", answer: "No — scanned or image-only PDFs have no extractable text, and this tool does not support OCR. It will honestly tell you when a PDF appears to be scanned rather than generating an empty document." },
        { question: "Is this useful for editing an old contract or form?", answer: "Yes, making an existing text-based PDF's content editable again is one of the most common reasons to use this tool." },
        ...
        { question: "Is PDF to Word available to use right now?", answer: "Yes — PDF to Word is live now and works entirely in your browser." },
      ],
    },
    az: {
      introduction: TOOL_INTRODUCTIONS["pdf-to-word"].az,
      valueProposition: "Tamamilə brauzerinizdə işləyərək PDF mətnini yenidən redaktə edilə bilən edin. Bu, mətni redaktə edilə bilən sənədə çıxarır — dəqiq düzülüş, cədvəl və ya şəkilləri saxlamır.",
      benefits: ["Mətn redaktə edilə bilən olur", "Sənədi yenidən yazmağa ehtiyac qalmır", "Pulsuz istifadə"],
      howToSteps: ["PDF-i yükləyin", "Alət onun real mətnini çıxarır", "Word sənədini yükləyin"],
      ...
      faq: [
        { question: "Bu, PDF-dəki dəqiq düzülüşü, cədvəlləri və şəkilləri saxlayır?", answer: "Xeyr — bu alət mətni redaktə edilə bilən sənədə çıxarır. Dəqiq vizual düzülüşü, cədvəlləri, daxil edilmiş şəkilləri və ya zəmanətli şrift/qalın/kursiv formatını saxlamır." },
        { question: "Bu alət pulsuzdur?", answer: "Bəli, bu alət, Codivio-nun bütün alətləri kimi, pulsuzdur." },
        { question: "Bu, skan edilmiş PDF-lərdə işləyir?", answer: "Xeyr — skan edilmiş və ya yalnız şəkildən ibarət PDF-lərdə çıxarıla bilən mətn yoxdur və bu alət OCR dəstəkləmir. PDF skan edilmiş görünərsə, boş sənəd yaratmaq əvəzinə bunu dürüstcə bildirəcək." },
        { question: "Bu, köhnə müqavilə və ya formanı redaktə etmək üçün faydalıdırmı?", answer: "Bəli, mövcud mətn əsaslı PDF-in məzmununu yenidən redaktə edilə bilən etmək bu aləti istifadə etməyin ən geniş yayılmış səbəbidir." },
        ...
        { question: "PDF-dən Word-ə hazırda istifadə üçün mövcuddur?", answer: "Bəli — PDF-dən Word-ə artıq aktivdir və tamamilə brauzerinizdə işləyir." },
      ],
    },
    tr: {
      introduction: TOOL_INTRODUCTIONS["pdf-to-word"].tr,
      valueProposition: "Tamamen tarayıcınızda çalışarak PDF metnini yeniden düzenlenebilir hale getirin. Bu, metni düzenlenebilir bir belgeye çıkarır — tam düzeni, tabloları veya görselleri korumaz.",
      benefits: ["Metin düzenlenebilir hale gelir", "Belgeyi yeniden yazmaya gerek kalmaz", "Ücretsiz kullanım"],
      howToSteps: ["PDF'yi yükleyin", "Araç gerçek metnini çıkarır", "Word belgesini indirin"],
      ...
      faq: [
        { question: "Bu, PDF'deki tam düzeni, tabloları ve görselleri korur mu?", answer: "Hayır — bu araç metni düzenlenebilir bir belgeye çıkarır. Tam görsel düzeni, tabloları, gömülü görselleri veya garantili yazı tipi/kalın/italik biçimlendirmeyi korumaz." },
        { question: "Bu araç ücretsiz mi?", answer: "Evet, bu araç, Codivio'nun tüm araçları gibi ücretsizdir." },
        { question: "Bu, taranmış PDF'lerde çalışır mı?", answer: "Hayır — taranmış veya yalnızca görselden oluşan PDF'lerde çıkarılabilir metin yoktur ve bu araç OCR desteklemez. PDF taranmış görünüyorsa, boş bir belge oluşturmak yerine bunu dürüstçe bildirir." },
        { question: "Bu, eski bir sözleşmeyi veya formu düzenlemek için faydalı mı?", answer: "Evet, mevcut bir metin tabanlı PDF'nin içeriğini yeniden düzenlenebilir hale getirmek bu aracı kullanmanın en yaygın nedenlerinden biridir." },
        ...
        { question: "PDF'den Word'e şu anda kullanılabilir mi?", answer: "Evet — PDF'den Word'e artık aktif ve tamamen tarayıcınızda çalışıyor." },
      ],
    },
  },
  ...
  "pdf-to-excel": {
    en: {
      ...
      faq: [
        ...
        { question: "What if the PDF has a full document instead of just a table?", answer: "The PDF to Word tool is designed for extracting a full document's text." },
